...
type CTAProps={
    type: "fillednoarrow"|"emptywitharrownoborder"|"filledwitharrow"|"empty"|"emptywitharrow"|"arrownoborder"
    url: string
    text: string
    bgcolor?: string
    bordercolor?: string
...
function setCallToAction(ctatype:"fillednoarrow"|"emptywitharrownoborder"|"filledwitharrow"|"empty"|"emptywitharrow"|"arrownoborder", url:string, text:string, bgcolor?:string, bordercolor?:string){
    switch(ctatype){
        case 'fillednoarrow':
            return (
